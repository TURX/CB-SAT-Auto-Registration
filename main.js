...
function startSettings() {
    if (confirm("Press OK to start settings, or press cancel to review settings.")) {
        ...
        if (GM_getValue("cbsatar-prefer", true)) {
            ...
            GM_setValue("cbsatar-preferSelect", prompt("Do you want to add more condition for Search Result Tables? (e.g: BANGKOK)", GM_getValue("cbsatar-preferSelect", "")));
                        ...
                        if (document.getElementById("newTestCenter") != null && document.getElementById("newSeatAvailable") != null) {
                            ...
                            if (document.getElementById("testCenterSearchResults_wrapper") != null) {
                                ...
                                while ($("#testCenterSearchResults_next").hasClass("disabled") == false) {
                                    ...
                                    if (document.getElementById("testCenterSearchResults_wrapper").innerText.search("Seat Available") != -1 && document.getElementById("testCenterSearchResults_wrapper").innerText.search(GM_getValue("cbsatar-preferSelect", "Seat Available")) != -1) {
